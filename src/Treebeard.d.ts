/**
 * The `react-treebeard` library does not come with types, so this is an attempt to provide a basic
 * set of types to make developing easier.
 *
 * Adapted and extended from https://github.com/storybookjs/react-treebeard/issues/186
 *
 * @TODO (som, 2019-12-17): make sure webpack is actually using these types! We may need to import
 * them in some way
 */
...
declare module "react-treebeard" {
  ...
  export type TreeDecorators = {
    [T in TreeDecoratorTypes]?: React.ElementType;
  };
  ...
  export interface TreeNodeProps {
    ...
    onSelect?: (node: TreeNode, toggled?: boolean) => void;
    style?: TreeTheme;
    animations?: TreeAnimations | boolean;
    decorators?: TreeDecorators;
  }

  export interface TreebeardProps extends TreeNodeProps {
